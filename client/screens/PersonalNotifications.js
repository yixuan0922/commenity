...
export default class PersonalNotifications extends React.Component {
    ...
    render() {
        return (
            <Block flex center>
                <Block style={{ marginTop: 60 }} flex-col>
                    <Text h6 style={{ paddingHorizontal: 2, paddingVertical: 5 }}>
                        Select Post Type
                    </Text>

                    <Block style={{ borderWidth: 1, borderRadius: 10, marginBottom: 30 }}>
                        <Picker
                        ...
                        >
                            <Picker.Item
                                label="Help Request"
                                value="help"
                                style={{ backgroundColor: "#ffd4d8", color: "red", fontSize: 15 }}
                            />
                            <Picker.Item
                                label="Give Request"
                                value="give"
                                style={{ backgroundColor: "#c4ffb3", color: "green", fontSize: 15 }}
                            />
                        </Picker>
                    </Block>
                </Block>
                ...
                <Button round color={argonTheme.COLORS.ACTIVE} onPress={this.handleSubmit}>
                    Submit
                </Button>
            </Block>
        );
